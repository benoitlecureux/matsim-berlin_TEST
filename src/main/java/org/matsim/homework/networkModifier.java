...
public class networkModifier {
    ...
    public static void main(String[] args) {
        ...
        Path inputNetwork = Paths.get("scenarios/berlin-v5.5-1pct/input/berlin-v5.5-network.xml.gz");
        Path outputNetwork = Paths.get("scenarios/berlin-v5.5-1pct/input/berlin-v5.5-network-MODIFIED.xml.gz");
        ...
        for(int i =0; i<links.length-1;i++){
            ...
            //network.getLinks().get(Id.createLinkId(linkToString)).setNumberOfLanes(2);
            network.getLinks().get(Id.createLinkId(linkToString)).setAllowedModes(Collections.singleton("pt"));
        }
